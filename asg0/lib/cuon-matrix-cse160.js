...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let a =  other1.elements[0] * other2.elements[0];
        let b = other1.elements[1] * other2.elements[1];
        let c = other1.elements[2] * other2.elements[2];
    ...
    magnitude() {
        ...
        m =  Math.sqrt(this.elements[0] * this.elements[0] + 
